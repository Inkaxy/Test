...
export function EditorCanvas({
  ...
  const handleSectionReorder = (newOrder: SectionId[]) => {
  ...
  const renderSection = (sectionId: SectionId) => {
    switch (sectionId) {
      case 'header':
        return (
          <div key="header" className="flex items-center justify-between mb-6 group relative">
            {/* Section drag handle */}
            <div className="absolute -left-12 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing">
      ...
      case 'stats':
        return (
          <div key="stats" className="group relative mb-6">
            {/* Section drag handle */}
            <div className="absolute -left-12 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing">
              <Move className="h-5 w-5 text-muted-foreground" />
            </div>
            ...
            >
              <StatsBar settings={settings} progress={progress} packedOrders={packedOrders} totalOrders={totalOrders} />
            </EditableElement>
          </div>
        );
      ...
      case 'grid':
        return (
          <div key="grid" className="group relative">
            {/* Section drag handle */}
            <div className="absolute -left-12 top-4 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing">
              <Move className="h-5 w-5 text-muted-foreground" />
            </div>
...
function StatsBar({ settings, progress, packedOrders, totalOrders }: StatsBarProps) {
  return (
    <div 
